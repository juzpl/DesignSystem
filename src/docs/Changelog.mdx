...
- Wyciągnięte z `NewClientPattern` shell sub-components: `InfoSection`, `SectionNav`, `RecordPageLayout`, `FieldGrid` + `Field`, `SummaryPanel` + `SummaryRow` — pozwalają budować strony create/detail dla dowolnego rekordu bez kopiowania monolitu.
