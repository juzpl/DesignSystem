  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:size-4",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-success-soft text-foreground border-success/30 [&>svg]:text-success",
        warning:
          "bg-warning-soft text-foreground border-warning/40 [&>svg]:text-warning",
        destructive:
          "bg-destructive-soft text-foreground border-destructive/30 [&>svg]:text-destructive",
      },
    },
