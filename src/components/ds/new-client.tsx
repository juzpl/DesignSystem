...
const sampleCompany: Company = {
  name: "MarkerPro Produkcja sp. z o.o.",
  street: "Przemysłowa",
  buildingNumber: "14",
  apartmentNumber: "",
  postalCode: "15-421",
...
const sampleShipping: ShippingDraft[] = [
  {
    ...
    city: "Białystok",
    country: "PL",
    email: "magazyn@markerpro.pl",
    phone: "+48 85 555 22 23",
    isDefault: true
  },
  {
    label: "Oddział Starosielce",
    name: "MarkerPro · Oddział",
    street: "Wysockiego",
    buildingNumber: "68",
    apartmentNumber: "",
    postalCode: "15-168",
...
export function NewClientPattern() {
  ...
  const [shortName, setShortName] = React.useState("MARKERPRO");
  const [invoiceEmail, setInvoiceEmail] = React.useState("faktury@markerpro.pl");
  ...
  const opiekunLabel =
    assignedEmployee === "monika"
      ? "Monika Kamińska · Handlowiec"
      : assignedEmployee === "kamil"
        ? "Kamil Brzeziński · Handlowiec"
        : "—";
              ...
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                ...
                <Field label="Opiekun handlowy">
                  ...
                  >
                    ...
                    <option value="monika">Monika Kamińska · Handlowiec</option>
                    <option value="kamil">Kamil Brzeziński · Handlowiec</option>
                  </NativeSelect>
                </Field>
